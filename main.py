...
def main():
    ...
    net.dir_saved = 'jobs/net_sampleLen=1_nDistSmpls=1_layerSizes=10,8,6,4_nEpoch=10000_batch=4096_nRepeats=10_nEpochInds=3496_LastEpochsInds=9998_DataName=var_u_lr=0.004_tanh'
    net.plot_network()
